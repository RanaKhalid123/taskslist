...
ListsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([list_entity_1.List]), config_1.ConfigService],
        providers: [lists_resolver_1.ListsResolver, lists_service_1.ListsService, config_1.ConfigService],
